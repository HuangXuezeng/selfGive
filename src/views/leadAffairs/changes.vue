...
export default {
  ...
  methods: {
    ...
    _exportExcel() {
      ...
      // let url = `/kukacms/self/turnover/exportExcel?jobnumber=${this.form.jobnumber}&name=${this.form.name}&startTime=${this.form.startTime}&endTime=${this.form.endTime}&classic=${this.form.classic}&deptIdStr=${this.form.deptIdStr}`
