    ...
    <div>
        <div class="myContents">
            ...
            <div class="allmoulde">
                ...
                personObj.a0101
                        ...
                        <div>
                            <span class="resuName">{{ personObj.a0190 }}</span>
                        </div>
                ...
                <div class="contents">
                    <div @click="seePdf">
                        ...
                        <span style="float:right;color:#767676;font-size:14px">查看</span>
                    </div>
                </div>
                <div class="other">
                    <div>
        ...
        <van-popup v-model="show" position="top" :style="{ height: '80%' }">
            ...
            <div style="text-align: right; padding-right: 10px">
                <span>
                    <van-button type="primary" size="small" @click="updateConfirm">确认修改</van-button>
                </span>
            </div>
        </van-popup>
        <!-- 上传头像的弹窗 -->
        <van-popup v-model="showImg" closeable close-icon="close" position="bottom" :style="{ height: '50%' }">
            <div class="uploadimg">
                <!-- <van-uploader v-model="fileList" :after-read="afterRead"  :max-count="1" /> -->
                <cube-upload :action="actions" v-model="fileData" :simultaneous-uploads="1" @files-added="filesAdded" @file-success="successImg" :max="1" />
            </div>
            <div class="imgText">
    ...
    export default {
        ...
        created() {
            ...
            if (
                ...
                localStorage.getItem("jobNum") == undefined
            ) {
                this.getUser();
            } else {
                this.init();
        ...
        methods: {
            ...
            //选择上传图片
            filesAdded() {
                this.actions.target = `/kukacms/self/uploadAvatar?type=2&jobnumber=${localStorage.getItem(
        "jobNum"
      )}`;
                this.showImg = false;
            },
            ...
            leadClick4() {
                window.open(
                    "https://res.exexm.com/dingtalk/common-no-cache/dingtalkindex.html?tenantId=kukahome&dd_full_screen=true",
                    "_self"
                );
            },
            ...mapMutations({
            ...
            seePdf() {
                window.open(
                    "http://ehrfile.kukahome.com:7020/operation/%E5%91%98%E5%B7%A5%E8%87%AA%E5%8A%A9%E6%93%8D%E4%BD%9C%E6%8C%87%E5%BC%95.pdf"
                );
            },
            handlerTeam(item) {
