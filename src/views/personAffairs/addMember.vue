<template>
    <div>
        <div>
            ...
            <van-field v-model="a841" label="家庭成员姓名：" placeholder="必填" label-width="8em"/>
            <van-field v-model="a843" label="成员性别：" placeholder="必填" @click="showSure = true" readonly/>
            <van-field v-model="a84013" label="成员工作单位：" placeholder="必填" label-width="8em"/>
            <van-field v-model="a84012" label="成员职务：" placeholder="必填"/>
            <van-field v-model="a84015" label="成员联系方式：" placeholder="必填" label-width="8em"/>
