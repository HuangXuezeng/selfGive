    ...
    <van-collapse v-model="activeNames">
      <div v-for="(item, index) in addteamlist" :key="item.recordid">
        <van-collapse-item :name="index">
          <template #title>
            <div class="fontweig">
              <van-tag mark type="primary" color="#07c160"
                >新增的团队{{ index + 1 }}</van-tag
              >
            </div>
          </template>
          <p>
          ...
          <p>
            <span>继任者1成熟度：</span>
            <span>{{
              item.a8TDPYXX016name ? item.a8TDPYXX016name : "无"
            }}</span>
          </p>
          <p>
            <span>继任者2：</span>
          ...
          <p>
            <span>继任者2成熟度：</span>
            <span>{{
              item.a8TDPYXX018name ? item.a8TDPYXX018name : "无"
            }}</span>
          </p>
          <p>
            <span>继任者3：</span>
          ...
          <p>
            <span>继任者3成熟度：</span>
            <span>{{
              item.a8TDPYXX020name ? item.a8TDPYXX020name : "无"
            }}</span>
          </p>
          <p>
            <span>审核人：</span>
    ...
    <van-collapse v-model="activeEditNames">
      <div v-for="(item, index) in updateteamlist" :key="item.recordid">
        ...
        <van-row
          type="flex"
          justify="center"
          v-if="activeEditNames.indexOf(index) != -1"
        >
          <van-col span="6">
            <div class="btn">
              <van-button
